...
(
	...
	[Matricula_Presente]	INT					NOT NULL,
	...
	CONSTRAINT [FK_dbo.Negocio_Frequencia_dbo.Negocio_Funcionario_Professor_ID] FOREIGN KEY ([Professor_ID])
		REFERENCES [dbo].[Negocio_Funcionario] ([Funcionario_ID]),
	CONSTRAINT [FK_dbo.Negocio_Frequencia_dbo.Matricula_Aluno_Matricula_ID] FOREIGN KEY ([Matricula_Presente])
